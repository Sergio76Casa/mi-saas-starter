...
const TenantSettings = () => {
  ...
  const uploadLogo = async (file: File) => {
    ...
    // We reuse the 'products' bucket if initialized, or ensure a public bucket exists.
  ...
  return (
    <div className="max-w-3xl animate-in fade-in duration-500 mx-auto md:mx-0 pb-20">
